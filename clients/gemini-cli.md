...
| Base URL | `https://api.recurdream.com` |
| API Version | `v1beta` |
...
```text
GET  https://api.recurdream.com/v1beta/models
POST https://api.recurdream.com/v1beta/models/{model}:generateContent
POST https://api.recurdream.com/v1beta/models/{model}:streamGenerateContent?alt=sse
```
